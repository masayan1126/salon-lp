...
const Modal = (props) => {
  const modalDisplay = props.isDisplay ? "" : "hidden";

  return (
    <section className={modalDisplay}>
      <div className="fixed z-10 inset-0 overflow-y-auto uc-fadein">
          ...
          >
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                ...
                <input
                  class="input border border-gray-400 appearance-none rounded w-full px-2 py-2 pt-2 pb-2 focus focus:border-indigo-600 focus:outline-none active:outline-none active:border-indigo-600"
                  id="password"
                  type="password"
                  autofocus
                />
