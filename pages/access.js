            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <div class="flex flex-col">
                  <h2 class="mb-2 text-left font-medium title-font mt-4 text-gray-900 text-xl">
                    Plaisir
                  </h2>
                  <p class="text-left text-gray-600 text-xs">
                    住所：大阪府和泉市繁和町399-5 JR阪和線
                  </p>
                  <p class="text-left text-gray-600 text-xs">
                    最寄駅からのルート：和泉府中駅から徒歩13分
                  </p>
                  <p class="text-left text-gray-600 text-xs">
                    電話番号：060-8400-3211
                  </p>
              ...
              <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-300 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p class="text-left leading-relaxed text-xs mb-4">
